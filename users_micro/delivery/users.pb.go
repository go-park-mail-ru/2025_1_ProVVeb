...
var file_users_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x2d, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x4c, 0x6f,
	...
	0x79, 0x12, 0x3b, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x16, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x47, 0x65,
	0x74, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09,
...
var file_users_proto_goTypes = []interface{}{
	(*GetUserByLoginRequest)(nil),   // 0: users.GetUserByLoginRequest
	(*GetAdminRequest)(nil),         // 1: users.GetAdminRequest
	(*GetAdminResponse)(nil),        // 2: users.GetAdminResponse
	...
	(*SaveUserDataRequest)(nil),     // 7: users.SaveUserDataRequest
	(*SaveUserDataResponse)(nil),    // 8: users.SaveUserDataResponse
	(*ValidateLoginRequest)(nil),    // 9: users.ValidateLoginRequest
	(*ValidatePasswordRequest)(nil), // 10: users.ValidatePasswordRequest
	(*UserExistsRequest)(nil),       // 11: users.UserExistsRequest
	(*UserExistsResponse)(nil),      // 12: users.UserExistsResponse
	(*emptypb.Empty)(nil),           // 13: google.protobuf.Empty
}
var file_users_proto_depIdxs = []int32{
	3,  // 0: users.GetUserResponse.user:type_name -> users.User
	3,  // 1: users.SaveUserDataRequest.user:type_name -> users.User
	7,  // 2: users.UsersService.SaveUserData:input_type -> users.SaveUserDataRequest
	5,  // 3: users.UsersService.GetUser:input_type -> users.GetUserRequest
	0,  // 4: users.UsersService.GetUserByLogin:input_type -> users.GetUserByLoginRequest
	4,  // 5: users.UsersService.DeleteUser:input_type -> users.DeleteUserRequest
	11, // 6: users.UsersService.UserExists:input_type -> users.UserExistsRequest
	9,  // 7: users.UsersService.ValidateLogin:input_type -> users.ValidateLoginRequest
	10, // 8: users.UsersService.ValidatePassword:input_type -> users.ValidatePasswordRequest
	1,  // 9: users.UsersService.GetAdmin:input_type -> users.GetAdminRequest
	8,  // 10: users.UsersService.SaveUserData:output_type -> users.SaveUserDataResponse
	6,  // 11: users.UsersService.GetUser:output_type -> users.GetUserResponse
	6,  // 12: users.UsersService.GetUserByLogin:output_type -> users.GetUserResponse
	13, // 13: users.UsersService.DeleteUser:output_type -> google.protobuf.Empty
	12, // 14: users.UsersService.UserExists:output_type -> users.UserExistsResponse
	13, // 15: users.UsersService.ValidateLogin:output_type -> google.protobuf.Empty
	13, // 16: users.UsersService.ValidatePassword:output_type -> google.protobuf.Empty
	2,  // 17: users.UsersService.GetAdmin:output_type -> users.GetAdminResponse
