...
INSERT INTO chats (first_profile_id, second_profile_id, last_message) VALUES 
(1, 2, 'Привет! Всё хорошо, спасибо. А у тебя?'),
(3, 4, 'С радостью! Когда тебе удобно?'),
(5, 6, 'Я больше люблю портреты, но природа — это классно!'),
(7, 8, 'Да, шикарный! Особенно последняя песня.'),
(9, 10, 'Спасибо! Твой тоже. Чем увлекаешься?');

INSERT INTO messages (chat_id, user_id, content, status) VALUES
(1, 1, 'Привет! Как дела?', 1),
(1, 2, 'Привет! Всё хорошо, спасибо. А у тебя?', 2),
(2, 3, 'Хочешь встретиться на кофе?', 1),
(2, 4, 'С радостью! Когда тебе удобно?', 2),
(3, 5, 'Я люблю фотографировать природу. А ты?', 1),
(3, 6, 'Я больше люблю портреты, но природа — это классно!', 2),
(4, 7, 'Ты слушала новый гимн СССР?', 1),
(4, 8, 'Да, шикарный! Особенно последняя песня.', 2),
(5, 9, 'Привет! У тебя очень интересный профиль.', 1),
